function montarQuestoesUX(){
	var questoes = new Array( 
		...
		["Qual a função do Teste de Usabilidade?", "Verificar a facilidade que o software/produto/site possui de ser claramente compreendido e manipulado pelo usuário.", "Verificar se o software/produto/site possui erros", "Verificar se o software/produto/site é desejado pelos usuários", "Teste de usabilidade não é uma atribuição do UX"],
